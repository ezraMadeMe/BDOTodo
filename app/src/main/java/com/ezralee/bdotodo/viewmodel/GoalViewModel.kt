...
class GoalViewModel(): ViewModel() {
    var data = MutableLiveData<GoalList>()
    var goal = MutableLiveData<GoalItem>()
    var plans = MutableLiveData<PlanUnit>()
    var plan = MutableLiveData<PlanItem>()
    var tasks = MutableLiveData<TaskList>()
    var task = MutableLiveData<TaskItem>()
